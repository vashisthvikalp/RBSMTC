    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.cardViewNewsEvents:
                ...
                startActivity(new Intent(this,NewsEvents.class));
                break;
            ...
            case R.id.cardViewUniversityResult:
                ...
                startActivity(new Intent(this,UniversityResult.class));
                break;
